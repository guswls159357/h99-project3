...
class FoodIntegrationTest {
    ...
    class RegisterRestaurants {
        ...
        void test3() throws JsonProcessingException {
            ...
            for(int i=0;i<foodsResponse.length;i++){
                System.out.println("음식 이름: "+foodsResponse[i].getName());
            }
    ...
    class FoodName {
        ...
        void test4() throws JsonProcessingException {
            ...
            // when
            Long restaurant2Id = restaurantDto2.getId();
    ...
    class FoodPrice {
        ...
        void test1() throws JsonProcessingException {
            ...
            ResponseEntity<Object> response = restTemplate.postForEntity(
                    ...
                    request,
                    Object.class);
            System.out.println("100원 미만 결과 코드 "+response.getStatusCode());
